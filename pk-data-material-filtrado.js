...
(function (global) {
  ...
  const PK_MATERIAL_FILTRADO = [
    ...
    },
    {
      ...
      variantes: [
        variant(2, "NUMEROS_FECHAS", "Un agente de Florida con seis años o menos de licencia debe completar, por cada período bienal, ¿qué combinación general de educación continua?", ["4 horas de ley y ética más 20 horas electivas", "4 horas de ley y ética más 16 horas electivas", "24 horas de ley y ética exclusivamente", "20 horas electivas sin curso obligatorio"], 0, "Con seis años o menos de licencia: 4 horas de actualización de ley y ética más 20 horas electivas, para un total de 24.", FLDFS),
        variant(3, "NUMEROS_FECHAS", "Un agente que ha mantenido la licencia de Florida durante más de seis años normalmente debe completar cada dos años:", ["4 horas de ley y ética más 16 electivas", "4 horas de ley y ética más 20 electivas", "Solo 4 horas de ley y ética", "30 horas sin distinción de materia"], 0, "Con más de seis años de licencia, el requisito general es 4 horas de ley y ética más 16 electivas, total 20.", FLDFS),
        variant(4, "EXCEPTO", "Respecto de la educación continua en Florida, ¿cuál afirmación es incorrecta?", ["El período de cumplimiento es generalmente bienal", "Incluye una actualización obligatoria de ley y ética", "Todo agente debe completar exactamente 24 horas sin importar su antigüedad", "El número de electivas puede variar según los años de licencia"], 2, "No todos completan exactamente 24 horas: quienes superan seis años de licencia generalmente cumplen 20 horas totales.", FLDFS)
      ]
    },
    {
